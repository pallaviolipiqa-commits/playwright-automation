...
_Generated: 2026-05-06T18:45:14.526Z_
...
Workspace `mcp.json` _(folder: TypeScript)_

- **c:\Users\palla\OneDrive\Documents\PlayWright\TypeScript\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\palla\.claude.json** — _File exists — no servers defined_
